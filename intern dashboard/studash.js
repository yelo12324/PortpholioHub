...
// ==========================================================
  ...
  async function fetchAppliedInternships() {
    ...
    const response = await fetch('https://portpholiohub.onrender.com/myApplications', {
...
window.addEventListener('DOMContentLoaded', async () => {
  try {
    ...
    const res = await fetch('https://portpholiohub.onrender.com/profile', {
      method: "GET",
      headers: { "Authorization": `Bearer ${token}` }
    });
    ...
    const user = result.data;  // ✅ pick the "data" object
